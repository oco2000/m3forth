...
( Ђ.—. ќв® Їа®бв® ®иЁЎЄ  а §а Ў®взЁЄ  вҐбв , Ї® ANS §¤Ґбм overflow
...
{ : GD5 123 SWAP 0 DO I 4 > IF DROP 234 ( LEAVE ) UNLOOP EXIT THEN LOOP ; -> }
{ 1 GD5 -> 123 }
{ 5 GD5 -> 123 }
{ 6 GD5 -> 234 }
...
\ CMOVE ®Ўп§ вҐ«м­® Ў ©в®ў®Ґ! Dmitry Yakimov
...
WORDS CR
HERE U.
DECIMAL HERE START-HERE @ - .( Size: ) . .( bytes) CR
.S
